...
class CodeQualityScanner:
    ...
    async def _analyze_generic_issues(self, file_path: str, content: str) -> List[Dict[str, Any]]:
        ...
        for i, line in enumerate(lines, 1):
            ...
            for pattern, secret_type in secret_patterns:
                if re.search(pattern, line_lower) and 'your_' not in line_lower and 'example' not in line_lower:
                    issues.append({
    ...
    def _create_work_item_from_issue(self, issue: Dict[str, Any], file_path: str) -> Dict[str, Any]:
    ...
    def _generate_description_from_issue(self, issue: Dict[str, Any], file_path: str) -> str:
    ...
    def _deduplicate_and_prioritize(self, work_items: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
